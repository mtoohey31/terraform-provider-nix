...
require (
	github.com/hashicorp/terraform-plugin-framework v1.2.0 // MPL-2.0
	github.com/hashicorp/terraform-plugin-go v0.14.3 // MPL-2.0
	github.com/hashicorp/terraform-plugin-testing v1.2.0 // MPL-2.0
